...
## PR #29 Resultlist での改変箇所
* resultlist/resultlistに診断結果（点数）および時刻が一覧表示されるようになった。  
4-24点が正常な回答を示し、負の数は未入力箇所があることを示します。  
...
* 結果をDBに保存して一覧表示する機能も実装
* 完成
* テストを少しだけ書いたが、画面遷移やボタンを押す操作がうまくいかない
